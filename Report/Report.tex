...
The Hydatis system was evaluated as a whole, focusing on end-to-end latency and the rule-based fusion of module outputs.

\subsubsection{End-to-End Latency}
From raw sensor input to final risk score, the system achieved an average latency of \textbf{450ms} under typical load, satisfying real-time safety requirements.
