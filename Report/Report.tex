...
\subsubsection{Geospatial Data Preprocessing}
The geospatial risk model was trained on a dataset of crime incidents in Tunisia. 
The preprocessing pipeline involved cleansing of the dataset to extract latitude and longitude pairs, and normalisation using a \texttt{StandardScaler} from the \texttt{Scikit-learn} library to prepare them for the clustering algorithms.

\section{Implementation of the Vocal Signal Processing Pipeline}
\subsubsection{Vocal Data Preprocessing}
...
\subsubsection{Behavioral Data Preprocessing}
