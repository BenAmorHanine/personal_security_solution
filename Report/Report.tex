...
%Building this was a challenge. Teaching an AI Machine to understand the subtle nuances of a specific dialect? How do you personalize safety without invading privacy? This report is the story of how we built a working prototype that can assess risk in under half a second, weaving together these different clues to get a clearer picture of your safety.
...
\\For instance, research has shown that Wav2Vec 2.0 can reach an accuracy of 79.58\% on the IEMOCAP benchmark\cite{wang2022finetunedwav2vec20hubertbenchmark},% [Wang et al., 2022],
...
This allows learning a user's unique temporal "pattern of life \cite{1339268pattern}," establishing a baseline for detecting unusual activity when a user deviates from their learned routine.
...
%The model's performance was measured on a 20\% hold-out test set, as detailed in the \textit{fineTuneTunBERT.ipynb} notebook.
