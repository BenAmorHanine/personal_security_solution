...
%Discarded will be a sentence in the coming subsec
\subsection{Crime Hotspot Forecasting and Spatial Analysis}%or crime hotsport forecasting or the principe of crime hotspot analysis
% Geographic crime patterns, spatial autocorrelation, hotspot theory
Crime hotspot detection is a specific application of spatial anomaly detection, 
a GIS technique used to identify unusual concentrations of events in a geographic area.
